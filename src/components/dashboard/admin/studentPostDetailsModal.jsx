...
const StudentPostDetailsModal = ({ postId, show, onHide }) => {
  ...
  const fetchPostDetails = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await postService.getStudentPostWithDetails(postId);
              ...
              <div className="d-flex align-items-center">
                ...
                <div>
                  ...
                  <small style={{ opacity: 0.9 }}>
                    Complete post and student information
                  </small>
                </div>
              </div>
              <button
                  ...
                  >
                    <div className="d-flex align-items-center justify-content-center gap-3">
                      <div className="position-relative d-inline-block">
                        {postData.student?.profilePhoto ? (
                          <img
                            src={postData.student.profilePhoto}
                            alt={postData.student.name}
                      ...
                      <div className="text-start flex-grow-1">
                        ...
                        >
                          {postData.student?.name || "Unknown Student"}
                        </h5>
                        <div className="text-muted small mb-2">
                          <i className="bi bi-envelope me-1"></i>
                          {postData.student?.email || "N/A"}
                        </div>
                        <div className="d-flex align-items-center gap-2 flex-wrap">
                          {getPremiumBadge(postData.premium)}
                          <div
                            className="d-inline-flex align-items-center px-3 py-2 rounded-pill"
                            style={{
                              background:
                          ...
                          >
                            ...
                            {postData.postCount || 0} Total Posts
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6 mb-3">
                      ...
                      <InfoCard
                        icon="geo-alt-fill"
                        label="Post Location"
                        value={postData.post?.townOrCity}
                        color="#f59e0b"
                      />
                      <InfoCard
                        icon="telephone-fill"
                        label="Student Phone"
                        value={postData.student?.phoneNumber}
                        color="#10b981"
                      />
                      <InfoCard
                        icon="geo-alt-fill"
                        ...
                        value={
                          postData.student?.cityOrTown ||
                          postData.student?.country
                            ? `${postData.student.cityOrTown || ""}${
                                postData.student.cityOrTown &&
                                postData.student.country
                                  ? ", "
                      ...
                      <InfoCard
                        ...
                        color="#8b5cf6"
                      />
                      {postData.premium?.premiumData && (
                        <>
                          {postData.premium.premiumData.paymentDate && (
                            <InfoCard
...
export default StudentPostDetailsModal;
